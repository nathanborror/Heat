...
extension WebBrowseTool {
    ...
    private static func summarize(_ args: Arguments) async throws -> Response {
        let summarizationService = try await PreferencesStore.shared.preferredSummarizationService()
        let summarizationModel = try await PreferencesStore.shared.preferredSummarizationModel()
